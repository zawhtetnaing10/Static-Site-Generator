...
class TestBlockToBlockType(unittest.TestCase):
    def test_heading(self):
        ...
        self.assertEqual(block_to_block_type(block_2), BLOCK_TYPE_HEADING)

    def test_not_heading(self):
        block = "###kfdj;adfka;fdk"
        block_2 = " # # #not heading"
        self.assertEqual(block_to_block_type(block), BLOCK_TYPE_PARAGRAPH)
        self.assertEqual(block_to_block_type(block_2), BLOCK_TYPE_PARAGRAPH)
    ...
    def test_ordered_list(self):
        ...
        self.assertEqual(block_to_block_type(
            ordered_list), BLOCK_TYPE_ORDERED_LIST)
    ...
    def test_not_ordered_list(self):
        ...
        result = all(block_to_block_type(block) !=
                     BLOCK_TYPE_ORDERED_LIST for block in not_ordered_list_array)
    ...
    def test_not_quote(self):
        ...
        result = all(block_to_block_type(block) !=
                     BLOCK_TYPE_QUOTE for block in not_quote_list)
    ...
    def test_unordered_list(self):
        ...
        self.assertEqual(block_to_block_type(
            unordered_list), BLOCK_TYPE_UNORDERED_LIST)
        self.assertEqual(block_to_block_type(
            unordered_list_2), BLOCK_TYPE_UNORDERED_LIST)
        self.assertEqual(block_to_block_type(
            unordered_list_3), BLOCK_TYPE_UNORDERED_LIST)
    ...
    def test_not_unordered_list(self):
        ...
        result = all(block_to_block_type(
            block) != BLOCK_TYPE_UNORDERED_LIST for block in not_unordered_list_array)
        self.assertEqual(result, True)
