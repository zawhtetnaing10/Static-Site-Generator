...
class TestTextNode(unittest.TestCase):
    ...
    def test_not_eq_none_url(self):
        ...
        node2 = TextNode("This is a text node",
                         TextType.NORMAL_TEXT, "https://www.boodev.com")
        self.assertNotEqual(node, node2)

    def test_not_eq_different_text(self):
        node = TextNode("This is an italic text node", TextType.NORMAL_TEXT)
        node2 = TextNode("This is a text node", TextType.NORMAL_TEXT)
        self.assertNotEqual(node, node2)

    def test_not_eq_different_urls(self):
        node = TextNode("This is a text node",
                        TextType.NORMAL_TEXT, "https://www.bootdev.com")
        node2 = TextNode("This is a text node",
                         TextType.NORMAL_TEXT, "https://www.google.com")
        self.assertNotEqual(node, node2)
